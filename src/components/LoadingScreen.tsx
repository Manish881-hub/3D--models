      ...
      {!loaded && (
        ...
        >
          <div className="flex flex-col items-center gap-8">
            ...
            >
              <svg viewBox="0 0 53 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-16 h-auto">
            ...
            <motion.button
              className="px-10 py-3 bg-yellow-400 text-black font-medium text-sm uppercase tracking-widest cursor-pointer"
